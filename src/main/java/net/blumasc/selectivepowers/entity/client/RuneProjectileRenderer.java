...
public class RuneProjectileRenderer extends EntityRenderer<RuneProjectileEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.fromNamespaceAndPath(SelectivePowers.MODID,"textures/item/light_rune.png");
    private static final RenderType RENDER_TYPE;

    public RuneProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    protected int getBlockLightLevel(RuneProjectileEntity entity, BlockPos pos) {
        return 15;
    }


    public void render(RuneProjectileEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    public ResourceLocation getTextureLocation(RuneProjectileEntity entity) {
