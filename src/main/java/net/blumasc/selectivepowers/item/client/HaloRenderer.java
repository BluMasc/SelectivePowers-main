...
public class HaloRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(SelectivePowers.MODID, "textures/entity/armor/curio/halo.png");

    public static HaloModel<LivingEntity> MODEL;

    public HaloRenderer() {
        super();
        ModelPart crownPart = Minecraft.getInstance().getEntityModels().bakeLayer(HaloModel.LAYER_LOCATION);
        MODEL = new HaloModel<>(crownPart);
    }
