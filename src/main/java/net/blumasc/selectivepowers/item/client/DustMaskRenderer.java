...
public class DustMaskRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(SelectivePowers.MODID, "textures/entity/armor/curio/dust_mask.png");

    public static DustMaskModel<LivingEntity> MODEL;

    public DustMaskRenderer() {
        super();
        ModelPart crownPart = Minecraft.getInstance().getEntityModels().bakeLayer(DustMaskModel.LAYER_LOCATION);
        MODEL = new DustMaskModel<>(crownPart);
    }
