...
public class WolfEarsRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(SelectivePowers.MODID, "textures/entity/armor/curio/wolf_ears.png");

    public static WolfEarsModel<LivingEntity> MODEL;

    public WolfEarsRenderer() {
        super();
        ModelPart crownPart = Minecraft.getInstance().getEntityModels().bakeLayer(WolfEarsModel.LAYER_LOCATION);
        MODEL = new WolfEarsModel<>(crownPart);
    }
