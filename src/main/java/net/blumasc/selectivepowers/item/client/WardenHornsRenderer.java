...
public class WardenHornsRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(SelectivePowers.MODID, "textures/entity/armor/curio/warden_horns.png");

    public static WardenHornsModel<LivingEntity> MODEL;

    public WardenHornsRenderer() {
        super();
        ModelPart crownPart = Minecraft.getInstance().getEntityModels().bakeLayer(WardenHornsModel.LAYER_LOCATION);
        MODEL = new WardenHornsModel<>(crownPart);
    }
