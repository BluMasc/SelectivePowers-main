...
public class DragonCurioRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(SelectivePowers.MODID, "textures/entity/armor/curio/dragon_shoulder.png");

    public static DragonCurioModel<LivingEntity> DRAGON_MODEL;

    public DragonCurioRenderer() {
        super();
        ModelPart dragonPart = Minecraft.getInstance().getEntityModels().bakeLayer(DragonCurioModel.LAYER_LOCATION);
        DRAGON_MODEL = new DragonCurioModel<>(dragonPart);
    }
