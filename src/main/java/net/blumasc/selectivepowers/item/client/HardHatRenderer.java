...
public class HardHatRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(SelectivePowers.MODID, "textures/entity/armor/curio/hard_hat.png");

    public static HardHatModel<LivingEntity> MODEL;

    public HardHatRenderer() {
        super();
        ModelPart crownPart = Minecraft.getInstance().getEntityModels().bakeLayer(HardHatModel.LAYER_LOCATION);
        MODEL = new HardHatModel<>(crownPart);
    }
