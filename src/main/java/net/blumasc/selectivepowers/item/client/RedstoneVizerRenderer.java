...
public class RedstoneVizerRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(SelectivePowers.MODID, "textures/entity/armor/curio/redstone_vizer.png");

    public static RedstoneVizerModel<LivingEntity> MODEL;

    public RedstoneVizerRenderer() {
        super();
        ModelPart crownPart = Minecraft.getInstance().getEntityModels().bakeLayer(RedstoneVizerModel.LAYER_LOCATION);
        MODEL = new RedstoneVizerModel<>(crownPart);
    }
